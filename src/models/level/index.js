...
const ClassSpecificCreatingSpellSlotSchema = new mongoose_1.Schema({
    _id: false,
    sorcery_point_cost: { type: Number, index: true },
    spell_slot_level: { type: Number, index: true },
});
const ClassSpecificMartialArtSchema = new mongoose_1.Schema({
    _id: false,
    dice_count: { type: Number, index: true },
    dice_value: { type: Number, index: true },
});
const ClassSpecificSneakAttackSchema = new mongoose_1.Schema({
    _id: false,
    dice_count: { type: Number, index: true },
    dice_value: { type: Number, index: true },
});
const ClassSpecificSchema = new mongoose_1.Schema({
    _id: false,
...
const SubclassSpecificSchema = new mongoose_1.Schema({
    _id: false,
...
const LevelSchema = new mongoose_1.Schema({
    ...
    features: [index_js_1.APIReferenceSchema],
...
exports.default = (0, mongoose_1.model)('Level', LevelSchema, 'levels');
